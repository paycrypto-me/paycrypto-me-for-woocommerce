...
class WC_Gateway_PayCryptoMe extends \WC_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->method_description = _x('PayCrypto.Me (Bitcoin) introduces a complete solution to receive your payments directly to your Bitcoin wallet (Non-custodial).', 'Gateway description', 'woocommerce-gateway-paycrypto-me');
        ...
        $this->description = $this->get_option('description') ?: __('Use directly your Bitcoin wallet to pay. Place the order to view the QR code and payment instructions.', 'woocommerce-gateway-paycrypto-me');
