...
0. **Corrigir os 2 erros pré-existentes em `BitcoinPaymentProcessorTest`** — investigar a colisão de shim `WC_Payment_Gateway` entre arquivos de teste **antes** de adicionar as suítes novas, para não herdar uma base de mocks quebrada.
