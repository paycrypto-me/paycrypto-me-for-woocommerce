...
/**
 * PayCrypto.Me Payments Blocks integration
 *
 * @since 1.0.3
 */
final class WC_Gateway_PayCrypto_Me_Blocks_Support extends AbstractPaymentMethodType
{
    /**
     * The gateway instance.
     *
     * @var WC_Gateway_PayCrypto_Me
     */
    private $gateway;
